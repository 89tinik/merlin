                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="example-select">Выберите статус</label>
                                                <select class="form-control" id="example-select" name="status">
                                                    <option value="success" <?php if ($userInfo['user_id'] == 'success') echo 'selected="selected"';?>>Онлайн</option>
                                                    <option value="warning" <?php if ($userInfo['user_id'] == 'warning') echo 'selected="selected"';?>>Отошел</option>
                                                    <option value="danger" <?php if ($userInfo['user_id'] == 'danger') echo 'selected="selected"';?>>Не беспокоить</option>
                                                </select>
                                        </div>
                                    </div>
