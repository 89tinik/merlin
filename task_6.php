            ...
            <div class="row js-list-filter" id="js-contacts">
                ...
                $peopleArr = [
                        ...
                        [
                            ...
                            'email'=>'esha.gray@smartadminwebapp.com',
                            'addres'=>'134 Hamtrammac, Detroit, MI, 48314, USA'
                        ]
                ];
                foreach ($peopleArr as $arr):
                ?>
                <div class="col-xl-4">
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?=mb_strtolower($arr['status'])?>oliver kopyov">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?=$arr['status']?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('<?=$arr['avatar']?>'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    ...
                                    <span class="text-truncate text-truncate-xl"><?=$arr['position']?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:<?=str_replace([' ', '-'], ['',''], $arr['phone'])?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i> <?=$arr['phone']?></a>
                                <a href="mailto:<?=$arr['email']?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i> <?=$arr['email']?></a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?=$arr['addres']?></address>
