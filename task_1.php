                    ...
                    <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                        ...
                        $agreementsArr = [
                            ...
                            [
                                'tag' => 'h3',
                                'class' => '',
                                'text' => 'Cookies and other similar technologies'
                            ],
                            [
                                'tag' => 'p',
                                'class' => 'mb-g',
                                'text' => 'We collect certain data through cookies and similar technologies (e.g. web beacons, tags,
                        ...
                        foreach ($agreementsArr as $arr){
                            $class = (!empty($arr['class'])) ? 'class="'.$arr['class'].'"' : '';
                            echo '<'.$arr['tag'].' '.$class.'>'.$arr['text'].'</'.$arr['tag'].'>';
                        }
                        ?>
